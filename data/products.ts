...
export const popularProducts: Product[] = allProducts.filter(
  (product) => product.id >= 1 && product.id <= 4
);

export const newCollections: Product[] = [
  allProducts[11], // id: 12
  allProducts[34], // id: 35
  allProducts[13], // id: 14
  allProducts[7],  // id: 8
  allProducts[14], // id: 15
  allProducts[1],  // id: 2
  allProducts[16], // id: 17
  allProducts[27], // id: 28
];
